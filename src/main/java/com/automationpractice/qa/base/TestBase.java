...
public class TestBase {
    ...
    public static WebEventListener eventListener;
		...
		public TestBase() {
		        ...
		        try{
		            prop=new Properties();
		            FileInputStream f= new FileInputStream(System.getProperty("user.dir")+"/src/main/java/com/automationpractice"
		...
		public static void initialization(){
	       ...
	       /*dynanmic wait - when all element is loaded rest of seconds would be ignored
	       giving selenium webdriver 20 seconds to wait for page to load
	       But Thread.sleep - script is pause, and even is element is not loaded its gone
	       */
